...
for phase in phases:
    ...
    anpath = base_path + '/dataset/OLD/no_target/data_{}/raw/gnnann.json'.format(phase)
    ...
    ''''''
    save_path = base_path + '/dataset/OLD/target/data_{}/raw/gnnann.json'.format(phase)
